...
const products: Product[] = [
  ...
  { id: "koubebeef", name: "神戸ビーフ", category: "肉", price: 4800, unit: "100g", image: "/images/uyfy.png", origin: "兵庫", tag: "特選", note: "高級和牛。炙りや寿司に。" },
  { id: "shatoburian", name: "シャトーブリアン", category: "肉", price: 7000, unit: "100g", image: "/images/red.png", origin: "厳選牧場", tag: "希少", note: "希少部位の極み。特別な日のメインに。" },
