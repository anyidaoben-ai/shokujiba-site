...
const products: Product[] = [
  ...
  { id: "dispense-potato-cut", name: "カット新じゃが", category: "根菜", price: 460, unit: "700g", image: "/images/dispense/potato-cut.png", origin: "倶知安", tag: "ほくほく", note: "断面まできれいな新じゃが。グリル、ポテトサラダ、スープに。" },
  ...
  { id: "dispense-tomato-sliced", name: "雫トマト", category: "野菜", price: 520, unit: "500g", image: "/images/dispense/tomato-sliced.png", origin: "富良野", tag: "濃赤", note: "水滴をまとった完熟感。カプレーゼや冷製パスタに。" },
